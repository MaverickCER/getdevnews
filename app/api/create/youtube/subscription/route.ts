...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`create/youtube/subscription channelId ${channelId}`);
    ...
    console.log(`create/youtube/subscription response for channelId ${channelId}`, response.statusText);
